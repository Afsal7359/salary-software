...
import BankEdit from '../Modal/BankEdit';
import Bankdelete from '../Modal/Bankdelete';

const Banklist = React.memo(({ formdata, setformdata }) => {
...
{showDeleteModal && selectedItem &&(<Bankdelete  setData={setData}
 Data={Data}
 item={selectedItem}
