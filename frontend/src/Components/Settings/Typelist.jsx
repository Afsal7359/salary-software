...
import TypeEdit from '../Modal/TypeEdit';
import TypeDelete from '../Modal/TypeDelete';
import { getallType } from '../../Apicalls/Type';

function Typelist({formdata,setformdata}) {
...
{showDeleteModal && selectedItem &&(<TypeDelete
 setData={setData}
 Data={Data}
 item={selectedItem}
