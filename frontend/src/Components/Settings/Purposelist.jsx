...
import PurposeEdit from '../Modal/PurposeEdit';
import PurposeDelete from '../Modal/PurposeDelete';

function Purposelist({formdata,setformdata}) {
    ...
    useEffect(() => {
      async function fetchData() {
        try {
          const result = await getallPurposee();
          setData(result.data);
          setIsLoading(false);
          // setrender(!render)
        } catch (error) {
