...
import AccountTypeedit from '../Modal/AccountTypeedit';
import AccountTypedelete from '../Modal/AccountTypedelete';


function Accounttypelist({formdata,setformdata}) {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const result = await getallAccountType();
        setData(result.data);
        setIsLoading(false);
        // setrender(!render)
      } catch (error) {
...
{showDeleteModal && selectedItem &&(<AccountTypedelete
 setData={setData}
 Data={Data}
 item={selectedItem}
