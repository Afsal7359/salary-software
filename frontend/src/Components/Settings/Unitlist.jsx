...
import UnitDelete from '../Modal/UnitDelete';


function Unitlist({formdata,setformdata}) {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const result = await getallUnite();
        setData(result.data);
        setIsLoading(false);
        // setrender(!render)
      } catch (error) {
...
const closeEditModal = () => {
  ...
  <EditUnit setData={setData}
  Data={Data}
    item={selectedItem}
    closeEditModal={closeEditModal}/>
)}

{showDeleteModal && selectedItem &&(<UnitDelete
 setData={setData}
 Data={Data}
 item={selectedItem}
