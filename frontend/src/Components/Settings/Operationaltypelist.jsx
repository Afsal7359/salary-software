...
import Operationaledit from '../Modal/Operationaledit';
import Operationaldelete from '../Modal/Operationaldelete';


function Operationaltypelist({formdata,setformdata}) {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const result = await getallOperationalType();
        setData(result.data);
        setIsLoading(false);
        // setrender(!render)
      } catch (error) {
...
{showDeleteModal && selectedItem &&(<Operationaldelete
 setData={setData}
 Data={Data}
 item={selectedItem}
...
export default Operationaltypelist;
