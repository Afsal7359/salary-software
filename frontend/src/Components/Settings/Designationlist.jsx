...
import Designationedit from '../Modal/Designationedit';
import Designationdelete from '../Modal/Designationdelete';

function Designationlist({formdata,setformdata}) {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const result = await getallDesignation();
        setData(result.data);
        setIsLoading(false);
        // setrender(!render)
      } catch (error) {
...
{showDeleteModal && selectedItem &&(<Designationdelete
 setData={setData}
 Data={Data}
 item={selectedItem}
