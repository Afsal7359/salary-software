...
const AddEmployeemaster = () => {
  ...
  return (
    <>
      ...
      {!state ? (
        <button
          className="btn btn-success submit-form mb-4 "
          onClick={handleclick}
        >
          Add Employee
        </button>
                    ...
                    <div className="row">
                      ...
                      <div className="col-12 col-md-6 col-xl-6">
                        <div className="form-group local-forms">
                          ...
                          <input
                            ...
                            type="text"
                            placeholder=""
                            value={`ME${count.toString().padStart(3, "0")}`}
                      ...
                      <div className="col-12 col-md-6 col-xl-6">
                        <div className="form-group local-forms">
                          ...
                          />
                          {errors.employeeno &&
                            errors.employeeno.type === "required" && (
                              <span className="text-danger">
                                Employee No is required
                              </span>
                            )}
                          {errors.employeeno &&
                            errors.employeeno.type === "minLength" && (
                              <span className="text-danger">
                                Employee No must be at least 1 character
                              </span>
                            )}
                        </div>
                      </div>
                        ...
                        <div className="form-group local-forms">
                          ...
                          {errors.address1 &&
                            errors.address1.type === "minLength" && (
                              <span className="text-danger">
                                Address-1 must be at least 2 characters
                              </span>
                            )}
                        </div>
                      </div>
                      ...
                      <div className="col-12 col-md-6 col-xl-6">
                        <div className="form-group local-forms">
                          ...
                          {errors.ifsc && errors.ifsc.type === "minLength" && (
                            <span className="text-danger">
                              IFSC code must be at least 5 characters
                            </span>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="col-12 col-md-6 col-xl-6">
                        <div className="form-group local-forms">
                          ...
                          />
                          {errors.panName &&
                            errors.panName.type === "required" && (
                              <span className="text-danger">
                                Pan Name is required
                              </span>
                            )}
                          {errors.panName &&
                            errors.panName.type === "minLength" && (
                              <span className="text-danger">
                                Pan Name must be at least 2 characters
                              </span>
                            )}
                        </div>
                      </div>
                      ...
                      <div className="col-12 col-md-6 col-xl-6">
                        <div className="form-group local-forms">
                          ...
                          />
                          {errors.basicSalary &&
                            errors.basicSalary.type === "required" && (
                              <span className="text-danger">
                                Basic Salary is required
                              </span>
                            )}
                          {errors.basicSalary &&
                            errors.basicSalary.type === "min" && (
                              <span className="text-danger">
					  ...
					  <div className="col-12 col-md-6 col-xl-6">
                        <div className="form-group local-forms">
                          <label>
                            Allowed Leaves<span className="login-danger">*</span>
                          </label>
                          <input
                            {...register("allowedleave", {
                              required: true,
                              min: 0,
                            })}
                            type="number"
                          ...
                          {errors.basicSalary &&
                            errors.basicSalary.type === "required" && (
                              <span className="text-danger">
                                Allowed Leave is required
                              </span>
                            )}
                          {errors.basicSalary &&
                            errors.basicSalary.type === "min" && (
                              <span className="text-danger">
                                Allowed Leave must be a positive number
                              </span>
                            )}
                        </div>
                      </div>
