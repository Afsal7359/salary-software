...
import { editAccountType } from '../../Apicalls/Accounttype';

function AccountTypeedit({ closeEditModal, item,setData,Data}) {
  ...
  const onSubmit = async (formData) => {
    ...
    formData._id =itemid;
    try {
      const response = await editAccountType(formData);
      if (response.success) {
