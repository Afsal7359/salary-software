...
import { deleteDepartment } from '../../Apicalls/Department';
function DepartmentDelete({ closeDeleteModal, item,setData,Data}) {
...
const handleDelete = async () => {
  try {
    ...
    const response = await deleteDepartment(item._id);
