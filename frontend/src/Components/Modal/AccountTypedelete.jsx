...
import { deleteAccountType } from '../../Apicalls/Accounttype';
function AccountTypedelete({ closeDeleteModal, item,setData,Data}) {
...
const handleDelete = async () => {
  try {
    ...
    const response = await deleteAccountType(item._id);
...
export default AccountTypedelete