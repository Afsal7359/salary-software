...
import { deletesalarymaster } from '../../Apicalls/salarymaster';
function Salarymasterdelete({ closeDeleteModal, item,setData,Data}) {
...
const handleDelete = async () => {
  try {
    ...
    const response = await deletesalarymaster(item._id);
...
export default Salarymasterdelete