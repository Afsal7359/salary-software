...
import { editOperationalType } from '../../Apicalls/Operational';

function Operationaledit({ closeEditModal, item,setData,Data}) {
  ...
  const onSubmit = async (formData) => {
    ...
    formData._id =itemid;
    try {
      const response = await editOperationalType(formData);
      if (response.success) {
