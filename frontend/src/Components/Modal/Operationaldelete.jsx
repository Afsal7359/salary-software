...
import { deleteOperationalType } from '../../Apicalls/Operational';
function Operationaldelete({ closeDeleteModal, item,setData,Data}) {
...
const handleDelete = async () => {
  try {
    ...
    const response = await deleteOperationalType(item._id);
...
export default Operationaldelete