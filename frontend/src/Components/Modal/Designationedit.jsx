...
import { editDesignation } from '../../Apicalls/Designation';

function Designationedit({ closeEditModal, item,setData,Data}) {
  ...
  const onSubmit = async (formData) => {
    ...
    formData._id =itemid;
    try {
      const response = await editDesignation(formData);
      if (response.success) {
